...
Config.Stores = {
    ...
    { -- Mall
        type = "clothing",
        coords = vec4(-563.92, -585.78, 34.68, 86.76),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vec3(-570.13, -589.37, 34.68),
            vec3(-558.99, -589.43, 34.68),
            vec3(-559.04, -582.13, 34.68),
            vec3(-570.13, -582.13, 34.68)
        }
    },
    {
        type = "clothing",
        coords = vec4(-587.27, -599.66, 41.43, 19.53),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vec3(-533.04, -620.16, 41.43),
            vec3(-532.47, -616.29, 41.51),
            vec3(-531.08, -616.05, 41.43),
            vec3(-531.05, -614.73, 42.22),
            vec3(-520.13, -614.76, 42.25),
            vec3(-520.1, -620.11, 41.43)
        }
    },
    {
        type = "barber",
        coords = vec4(-554.14, -585.13, 41.43, 45.57),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vec3(-554.71, -588.55, 41.43),
            vec3(-557.4, -588.51, 41.43),
            vec3(-557.37, -579.59, 41.43),
            vec3(-554.71, -579.58, 41.43)
        }
    },
    {
        type = "tattoo",
        coords = vec4(-586.68, -599.8, 41.43, 318.8),
        size = vector3(4, 4, 4),
        rotation = 45,
        usePoly = true,
        points = {
            vec3(-583.18, -605.52, 41.43),
            vec3(-582.69, -594.91, 41.43),
            vec3(-590.95, -595.06, 41.43),
            vec3(-590.95, -604.92, 41.43),
        }
    },
}

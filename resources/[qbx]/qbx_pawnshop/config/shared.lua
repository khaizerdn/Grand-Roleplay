return {
    ...
    pawnItems = {
        ...
        { item = 'valuable_diamond_necklace',  price = math.random(3000, 4500) },
        ...
        { item = 'valuable_silver_bar',        price = math.random(160, 360) },    
        { item = 'valuable_gold_bar',          price = math.random(1220, 2240) },
